...
<%}} %>
    ...
    <div class="col-md-8 col-md-offset-1">
        ...
        <fieldset>
          ...
          <!-- Form Name -->
           <legend>Approved History</legend>
  ...
  SELECT   employeenames,employeenumber,charge_to,phonenumber,message,ticket_no,complaint_date,priority,status_inst_id,approved_date from customer where status_inst_id = 1 order by complaint_date desc  ;
        </sql:query>
    <center>
        <form>
            ...
            <table  id="myTable">
                ...
                <tr class="header" >
                    ...
                    <th style="width:40%;">Priority</th>
                     <th style="width:30%;">Complaint Date</th>
                      <th style="width:30%;">Approved Date</th>
                ...
                <tbody>
                    <tr>
                     ...
                     <td><c:out value="${row.Approved_date}"/></td>
