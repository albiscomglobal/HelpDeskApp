                ...
                <tbody>
                    <tr>
                     ...
                     <td><c:out value="${row.ticket_no}"/></td>
                      ...
                      <td>  <a href="/customermanagement/Table_Ticket?ticket_no=<c:out value="${row.ticket_no}"/>">
					<!-- <button type="submit" class="btn btn-default">PDF Report</a> </button></td> -->
					<button type="button" class="btn btn-success">PDF Report</button></a> </td>
                    </tr>
                     </tbody>
                </c:forEach>
            </table>
