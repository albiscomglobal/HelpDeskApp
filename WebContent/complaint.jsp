...
<%}} %>
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="index2.html" class="logo">
          ...
          <span class="logo-lg"><b>Customer App</b></span>
        </a>
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="active treeview">
              <a href="#">
                <i class="fa fa-dashboard"></i> <span>Reception</span> <i class="fa fa-angle-left pull-right"></i>
              </a>
   ...
   <form action="Bookappointment" method="post" class="form-horizontal">
 ...
 <div class="col-xs-8">
    <label for="exampleInputEmail1">Employee Names</label><span id="MainPlaceHolder1_RequiredFieldValidator17" style="color:Red;display:none;">Please enter Employee Name</span>
&nbsp;<input name="employeenames" type="text"id="employeename" class="form-control" placeholder="Enter Employee Name"  required />     
...
&nbsp;<input name="employeenumber" type="text"id="employeenumber" class="form-control" placeholder="Enter Number"  required />     
    ...
    <div class="form-group">
 <div class="col-xs-8">
    <label for="exampleInputEmail1">Phone Number</label><span id="MainPlaceHolder1_RequiredFieldValidator17" style="color:Red;display:none;">Please enter Mobile Number</span>
&nbsp;<input name="phonenumber" type="text"id="phonemobilenumber" class="form-control" placeholder="Enter Mobile"  required />     
...
<div class="form-group">
 ...
 <select name="charge_to" id="charge_to" class="form-control"  required  >
...
&nbsp;<textarea name="message" type="text" id="message" class="form-control" placeholder="EnterComment"  required >  </textarea> 
</div>
</div>
...
<div class="form-group">
 ...
 <select name="priority" id="charge_to" class="form-control"  required  >
