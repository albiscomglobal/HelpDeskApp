...
/**
 * Servlet implementation class CustomerExcelReport
 */
@WebServlet("/CustomerExcelReport")
public class CustomerExcelReport extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public CustomerExcelReport() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try(Connection con= DBConnection.getConnection()){
		      ...
		      .executeQuery("SELECT   employeenames,employeenumber,charge_to,phonenumber,message,ticket_no,priority,complaint_date from customer order by complaint_date desc ;");
