...
<html>
  <head>
    <meta charset="UTF-8">
    <title>Users Created Successful page</title>
...
<%} %>
          ...
          <div class="navbar-custom-menu">
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown messages-menu">
                ...
                <c:forEach var="row" items="${result24.rows}">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">User successfully Created</li>
          </ol>
        </section>
 ...
 <div class="container">
    ...
    <h4 class ="alert alert-success col-md-4 col-md-offset-4">User Created Successfully </h4>
