...
<%}} %>
    ...
    <div class="col-md-8 col-md-offset-1">
          ...
          <!-- Form Name -->
          <legend>PHC [PRIMARY HEALTH CARE]</legend>

        <sql:setDataSource var="webappDataSource"
    driver="com.mysql.jdbc.Driver" url="jdbc:mysql://192.168.100.1:3306/customermanagement?zeroDateTimeBehaviour=convertToNull"
    user="root" password="password"   />
 
        <sql:query dataSource="${webappDataSource}" var="result" >
      
  SELECT   employeenames,employeenumber,charge_to,phonenumber,message,ticket_no,complaint_date from customer where charge_to like '%PHC%' order by complaint_date desc ;
        </sql:query>
    <center>
        <form>
