...
<html>
  <head>
    <meta charset="UTF-8">
    <title>update Blood Glucose Test</title>
...
if((request.getSession(false).getAttribute("MedicalLab")== null) )
{
...
<%}} %>
   ...
   <c:set var="ticket_no" value="${param.ticket_no}" scope="session" />  

 <sql:query dataSource="${webappDataSource}" var="result" >
  SELECT   employeenames,employeenumber,charge_to,phonenumber,message,ticket_no,complaint_date from customer   WHERE ticket_no =? ;
  <sql:param value="${param.ticket_no}" />
</sql:query> 
            <form action="updateddbcustomer.jsp"  method="post"> 
       <div class="container">
...
<div class="form-group">
  <div class="col-xs-8">
 <input name="ticket_no" type="hidden"  value="${ticket_no}" />
       ...
       <div class="form-group">
 <div class="col-xs-8">
    <label for="exampleInputEmail1">Employee Name</label><span id="MainPlaceHolder1_RequiredFieldValidator17" style="color:Red;display:none;">Please Employee Names</span>
&nbsp;<input name="employeenames" type="text" value="${row.employeenames}"  class="form-control" placeholder="Enter Employee Names"  required />
     </div>
  </div>
  
  <div class="form-group">
  <div class="col-xs-8">
    <label for="exampleInputEmail1">Employee Number</label><span id="MainPlaceHolder1_RequiredFieldValidator17" style="color:Red;display:none;">Please enter Employee Number</span>
&nbsp;<input name="employeenumber" type="text"  value="${row.employeenumber}" class="form-control" placeholder="employeenumber" required/>
    </div> 
  </div>
...
<div class="form-group">
  <div class="col-xs-8">
    <label for="exampleInputEmail1">Phone Number</label><span id="MainPlaceHolder1_RequiredFieldValidator17" style="color:Red;display:none;">Please enter Phone Number</span>
&nbsp;<input name="phonenumber" type="text"  value="${row.phonenumber}" class="form-control" placeholder="phonenumber" required/>
    </div> 
  </div>
   ...
   <div class="form-group">
 <div class="col-xs-8">
    <label for="exampleInputEmail1">Charge To Department</label> 
   <select name="charge_to" value="${row.charge_to}"  class="form-control"  required  >
	...
	<option value="MDA">MDA</option>
	 ...
	 <option value="LGA">LGA</option>
	  ...
	  <option value="chamswitch">CHAMS SWITCH</option>
</select>
 </div>
    </div>
 ...
 <div class="form-group">
  <div class="col-xs-8">
    <label for="exampleInputEmail1">Complaint</label><span id="MainPlaceHolder1_RequiredFieldValidator17" style="color:Red;display:none;">Please enter Complaint</span>
&nbsp;<input name="message" type="text"  value="${row.message}" class="form-control" placeholder="message" required/>
    </div> 
  </div>
 ...
 <select name="priority" value="${row.priority}" class="form-control"  required  >
    ...
    <br>
          ...
          <div class="form-group">
           ...
           <a href="/customermanagement/SuperAdminHomePage.jsp"
                ...
                <button type="submit" class="btn btn-success" style="margin:5px"> Update</button>
