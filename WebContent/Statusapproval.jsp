...
<%}} %>
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="active treeview">
              <a href="#">
                 <i class="fa fa-dashboard"></i> <span>Customer Apps</span> <i class="fa fa-angle-left pull-right"></i>
              </a>
   ...
   <c:set var="ticket_no" value="${param.ticket_no}" scope="session" /> 
    ...
    <sql:update dataSource="${webappDataSource}" var="count"  >
           UPDATE customer SET   status_inst_id = 1, Approved_date=current_timestamp
           WHERE ticket_no= '${param.ticket_no}'
    
          </sql:update>
     <c:if test="${count>=1}">
       
    <h4 class ="alert alert-success col-md-4 col-md-offset-4" align="center">Status Finally Approved </h4>
     </c:if>


 <div class="col-md-6 center-block">
              <div class="pull-middle">
            <a href="/customermanagement/Pending.jsp"
						class="btn btn-danger">Back To Pending Status Page</a>
						</div>
           </div>   
