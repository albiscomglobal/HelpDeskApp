...
<%}} %>
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="active treeview">
              <a href="#">
                 <i class="fa fa-dashboard"></i> <span>History</span> <i class="fa fa-angle-left pull-right"></i>
              </a>
  ...
  SELECT   employeenames,employeenumber,charge_to,phonenumber,message,ticket_no,complaint_date,priority,status_inst_id,approved_date from customer where status_inst_id = 0 order by complaint_date desc  ;
        </sql:query>
    <center>
        <form>
            ...
            <table  id="myTable">
                ...
                <tr class="header" >
                    ...
                    <th style="width:20%;">Mobile Number</th>
                      <th style="width:20%;">Charge To </th>
                ...
                <tbody>
                    <tr>
                     <td><c:out value="${row.employeenames}"/></td>
                     <td><c:out value="${row.employeenumber}"/></td>
                     <td><c:out value="${row.phonenumber}"/></td>
                      <td><c:out value="${row.charge_to}"/></td>
                     <td><c:out value="${row.message}"/></td>
                     <td><c:out value="${row.ticket_no}"/></td>
                     <td><c:out value="${row.priority}"/></td>
                     <td><c:out value="${row.complaint_date}"/></td> 
                        
  
                      
					<td>  <a href="Statusapproval.jsp?ticket_no=<c:out value="${row.ticket_no}"/>">
					<!-- <button type="button" class="class="btn btn-warning" >Approved </button></a> </td> -->
					<button type="button" class="btn btn-info">Approved</button></a> </td>
                    </tr>
                     </tbody>
                </c:forEach>
