...
<%}} %>
    ...
    <div class="col-md-8 col-md-offset-1">
        ...
        <fieldset>
          ...
          <!-- Form Name -->
           <legend>Customers History</legend>
  ...
  SELECT   employeenames,employeenumber,charge_to,phonenumber,message,ticket_no,complaint_date from customer order by complaint_date desc ;
        </sql:query>
    <center>
        <form>
                ...
                <tbody>
                    <tr>
                     ...
                     <td><c:out value="${row.ticket_no}"/></td>
                      ...
                      <td>  <a href="updatecustomer.jsp?ticket_no=<c:out value="${row.ticket_no}"/>">
					<button type="submit" class="btn btn-default">Update</a> </button></td>
                    </tr>
                     </tbody>
                </c:forEach>
            </table>
