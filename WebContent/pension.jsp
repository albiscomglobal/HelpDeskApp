...
<%}} %>
    ...
    <div class="col-md-8 col-md-offset-1">
          ...
          <!-- Form Name -->
          <legend>PENSION [CIVIL PENSION & LOCAL GOVERNMENT PENSION]</legend>
  ...
  SELECT   employeenames,employeenumber,charge_to,phonenumber,message,ticket_no,complaint_date from customer where charge_to like '%PENSION%' order by complaint_date desc ;
        </sql:query>
    <center>
        <form>
