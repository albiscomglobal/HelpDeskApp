...
<%}} %>
    ...
    <div class="col-md-8 col-md-offset-1">
          ...
          <!-- Form Name -->
          <legend>TESCOM [TEACHERS ESTABLISMENT COMMISSION]</legend>
  ...
  SELECT   employeenames,employeenumber,charge_to,phonenumber,message,ticket_no,complaint_date from customer where charge_to like '%HIGH%' order by complaint_date desc ;
        </sql:query>
    <center>
        <form>
