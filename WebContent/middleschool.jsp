...
<html>
  <head>
    <meta charset="UTF-8">
    <title> MIDDLE SCHOOL REPORT</title>
...
<%}} %>
  ...
  SELECT   employeenames,employeenumber,charge_to,phonenumber,message,ticket_no,complaint_date from customer where charge_to like '%MIDDLE%' order by complaint_date desc ;
        </sql:query>
    <center>
        <form>
